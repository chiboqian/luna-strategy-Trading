...
Usage:
    python Trading/Trading/alpaca_close_cli.py AAPL MSFT
    python Trading/Trading/alpaca_close_cli.py --all
"""
...
def main():
    ...
    if args.scan_rules:
        ...
        if not rules_dir:
            ...
            default_path = script_path.parent.parent / "config" / "streaming_rules"
